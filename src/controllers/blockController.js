...
const postBlockInfo = async (req, res) => {
    if (req.body.idBlock && req.body.idBlocked && req.body.idConversation) {
        const blockDataInfo = await blockService.handleAddInfoBlock(req.body.idBlock,req.body.idBlocked, req.body.idConversation );
...
const deleteBlockInfo = async (req, res) => {
    if (req.query.idSession  && req.query.idConversation) {
        await blockService.handleDeleteInfoBlock(req.query.idSession, req.query.idConversation );
